...
@pytest.mark.asyncio
async def test_message_delete(client: Client, settings, chat: Chat, user_factory, client_factory):
    #
    # create users
    #
